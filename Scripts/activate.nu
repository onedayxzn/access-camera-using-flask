...
def-env activate-virtualenv [] {
    ...
    let virtual-env = 'D:\PROJECT\Medium\Access-camera-using-flask\access-camera-using-flask'
    let bin = 'Scripts'
    let path-sep = ';'
...
alias deactivate = source 'D:\PROJECT\Medium\Access-camera-using-flask\access-camera-using-flask\Scripts\deactivate.nu'
